      ...
      read_sensor();
       ...
       if(cmp<=20 && cmp>=-20)
        ...
        if(adc[adc_min]<800)
        {
         ...
         else if(adc_min==1)    motor(255,0,-255,0);           // motor(255,128,-255,-128);
         ...
         else if(adc_min==9)    motor(-128,-255,128,255);      // motor(-255,-128,255,128);
         ...
         else if(adc_min==15)   motor(0,255,0,-255);           // motor(128,255,-128,-255);
       ...
       {  
          if(shb<180)
           {
            motor(-255-e,-255+e,255+e,255-e); 
           }    
          /* else if(shb>260 && shl>200)
           {
           motor(255,255,-255,-255);
           } 
           else if(shb>280 && shr>250)
           {
           motor(255,255,-255,-255);
           } 
           else if(shl>300)
